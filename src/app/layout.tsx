...
export const metadata: Metadata = {
  title: "TechFlow - Innovative IT Solutions for Modern Business",
  description: "Transform your business with TechFlow's comprehensive IT solutions including cloud migration, cybersecurity, and custom software development. Expert technology consulting for companies of all sizes.",
  keywords: "IT solutions, cloud migration, cybersecurity, software development, technology consulting, digital transformation, IT services",
  ...
  openGraph: {
    title: "TechFlow - Innovative IT Solutions for Modern Business",
    description: "Transform your business with comprehensive IT solutions including cloud migration, cybersecurity, and custom software development.",
    siteName: "TechFlow",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763484386222-nkenny1f.jpg",
  ...
  twitter: {
    ...
    title: "TechFlow - Innovative IT Solutions for Modern Business",
    description: "Transform your business with comprehensive IT solutions including cloud migration, cybersecurity, and custom software development.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763484386222-nkenny1f.jpg"]
  },
  robots: {
    index: true,
    follow: true
